...
export const metadata = {
  ...
  alternates: {
    canonical: "https://fastalfazcab.in/location/panjim",
  },
  keywords: [
    "cab in Panjim Goa",
    "taxi Panjim Goa",
  ...
  openGraph: { title: "Cab Service in Panjim Goa | Alfaz", description: "Reliable cab and taxi service in Panjim — Fontainhas, Miramar, Dona Paula and beyond. Available 24/7.", url: "https://fastalfazcab.in/location/panjim", siteName: "Alfaz Cab Service", images: [{ url: "https://fastalfazcab.in/images/Logo/Logo.webp", width: 1200, height: 630, alt: "Alfaz Cab Service — Panjim Goa" }], locale: "en_IN", type: "website" },
};

const taxiServiceSchema = { "@context": "https://schema.org", "@type": "TaxiService", name: "Alfaz Cab Service — Panjim Goa", image: "https://fastalfazcab.in/images/Logo/Logo.webp", description: "Reliable cab and taxi service in Panjim for city trips, sightseeing, airport transfers, and local rides.", telephone: "+91-7489415896", priceRange: "₹₹", areaServed: ["Panjim", "Fontainhas", "Miramar", "Dona Paula", "Mandovi Riverfront"], address: { "@type": "PostalAddress", addressLocality: "Panjim", addressRegion: "Goa", addressCountry: "IN" }, geo: { "@type": "GeoCoordinates", latitude: "15.4909", longitude: "73.8278" } };
const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://fastalfazcab.in/" }, { "@type": "ListItem", position: 2, name: "Panjim Goa Cab Service", item: "https://fastalfazcab.in/location/panjim" }] };
